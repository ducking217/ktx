 ...
 * Khu vực: Core / Trang chủ (Landing)
 
 * Vai trò: Dựng dữ liệu landing (stats/phòng/thông báo) và xử lý form liên hệ.
...
class TrangChuService implements TrangChuServiceInterface
{
    ...
    {
        return Cache::remember('landing.homepage:v1', now()->addSeconds(60), function (): array {
