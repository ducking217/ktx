...
<aside class="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-slate-200 bg-slate-50/50 lg:flex backdrop-blur-xl">
    ...
    <nav class="flex-1 overflow-y-auto px-4 py-4 custom-scrollbar">
        ...
        <div class="space-y-1">
            @if(!$isAlumni)
                <a href="{{ route('student.danhsachphong') }}" class="saas-sidebar-link {{ request()->routeIs('student.danhsachphong') ? 'saas-sidebar-link-active' : '' }}">
            ...
            @endif
            <a href="{{ route('student.hopdongcuatoi') }}" class="saas-sidebar-link {{ request()->routeIs('student.hopdongcuatoi') ? 'saas-sidebar-link-active' : '' }}">
        ...
        <div class="space-y-1">
            <a href="{{ route('student.hoadoncuaem') }}" class="saas-sidebar-link {{ request()->routeIs('student.hoadoncuaem', 'student.phongcuatoi.hoadon.chitiet') ? 'saas-sidebar-link-active' : '' }}">
        ...
        <div class="space-y-1">
            ...
            @endif
            <a href="{{ route('student.kyluatcuaem') }}" class="saas-sidebar-link {{ request()->routeIs('student.kyluatcuaem') ? 'saas-sidebar-link-active' : '' }}">
