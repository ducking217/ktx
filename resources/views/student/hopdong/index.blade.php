            ...
            @if($hasActiveContract)
                ...
                <div class="saas-card p-6 bg-rose-50/30 border-rose-100/60">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                        ...
                        <form action="{{ route('student.yeucautraphong') }}" method="POST" onsubmit="return confirm('Gửi yêu cầu trả phòng và thanh lý hợp đồng? Ban quản lý sẽ xem xét trước khi thực hiện.')">
                            @csrf
                            <button
                                type="submit"
