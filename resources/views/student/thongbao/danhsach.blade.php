    ...
    <div class="space-y-8">
        ...
        <div class="space-y-4">
            @forelse($thongbao as $tb)
                <a href="{{ route('student.chitietthongbao', $tb->id) }}" class="saas-card p-6 flex items-start gap-6 group hover:border-blue-200 transition-all hover:shadow-xl hover:shadow-blue-500/5">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-2">
                            <h3 class="text-base font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{{ $tb->tieu_de }}</h3>
