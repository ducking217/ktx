<x-admin-layout>
    ...
    <div class="space-y-6">
        ...
        >
            <a href="{{ route('admin.toanha.tao') }}" class="saas-btn-primary h-9 px-4 text-xs shadow-sm shadow-blue-500/20">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        <td class="py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-xs font-bold text-slate-900 group-hover:text-blue-600 transition-colors uppercase tracking-tight">{{ $toaNha->ten_toa_nha }}</div>
                            </div>
                        </td>
                        <td class="py-4">
                        ...
                        <td class="py-4 text-right">
                            <div class="flex items-center justify-end gap-1">
                                <a href="{{ route('admin.toanha.chitiet', $toaNha->id) }}" class="h-8 w-8 inline-flex items-center justify-center text-slate-400 hover:text-blue-600 hover:bg-blue-50 border border-transparent hover:border-blue-100 rounded-lg transition-all" title="Chỉnh sửa">
