                ...
                @forelse($hopdong as $item)
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="py-5">
                            ...
                            <div class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1.5">{{ $item->sinhvien?->ma_sinh_vien ?? 'N/A' }}</div>
                        </td>
                        <td class="py-5">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-bold text-slate-700">{{ $item->giuong?->phong?->ten_phong ?? 'N/A' }}</span>
                            </div>
                        </td>
                ...
                <div class="space-y-6">
                    <div class="p-6 rounded-2xl bg-slate-50 border border-slate-200/60 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mt-1.5">Mã SV: {{ $item->sinhvien->ma_sinh_vien ?? 'N/A' }}</div>
                        </div>
                    </div>
