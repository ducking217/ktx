    ...
    <div class="flex h-full flex-col">
        ...
        <nav class="flex-1 overflow-y-auto px-4 space-y-8 scrollbar-hide">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.trangchu') }}" class="saas-sidebar-link {{ request()->routeIs('admin.trangchu') ? 'saas-sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.activity-log') }}" class="saas-sidebar-link {{ request()->routeIs('admin.activity-log') ? 'saas-sidebar-link-active' : '' }}">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Nhật ký
                    </a>
                    <a href="{{ route('admin.cauhinh.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.cauhinh.*') ? 'saas-sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.accounts.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.accounts.*') ? 'saas-sidebar-link-active' : '' }}">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.toanha.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.toanha.*') ? 'saas-sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.phong.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.phong.*') ? 'saas-sidebar-link-active' : '' }}">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m4 0h1m-4 12h1m4 0h1m-4-4h1m4 0h1m-4-4h1m4 0h1"/></svg>
                        Phòng & Tài sản
                    </a>
                    <a href="{{ route('admin.sinhvien.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.sinhvien.*') ? 'saas-sidebar-link-active' : '' }}">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        Sinh viên
                    </a>
                    <a href="{{ route('admin.dangky.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.dangky.*') ? 'saas-sidebar-link-active' : '' }}">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            <span>Đăng ký</span>
                        </div>
                        @if ($soDonChoDuyet > 0)
                            <span class="ml-auto flex h-4 w-4 items-center justify-center rounded-full bg-brand-emerald text-[10px] font-bold text-white">{{ $soDonChoDuyet }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.hopdong.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.hopdong.*') ? 'saas-sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.giahan.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.giahan.*') ? 'saas-sidebar-link-active' : '' }}">
                    ...
                    <a href="{{ route('admin.kyluat.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.kyluat.*') ? 'saas-sidebar-link-active' : '' }}">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.hoadon.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.hoadon.*') ? 'saas-sidebar-link-active' : '' }}">
                        <div class="flex items-center gap-3">
                        ...
                        @if ($soCongNo > 0)
                            <span class="ml-auto saas-badge saas-badge-warning">{{ $soCongNo }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.baocao.taichinh') }}" class="saas-sidebar-link {{ request()->routeIs('admin.baocao.*') ? 'saas-sidebar-link-active' : '' }}">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.baohong.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.baohong.*') ? 'saas-sidebar-link-active' : '' }}">
                        <div class="flex items-center gap-3">
                        ...
                        @if ($soSuCoMo > 0)
                            <span class="ml-auto saas-badge saas-badge-error">{{ $soSuCoMo }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.baotri.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.baotri.*') ? 'saas-sidebar-link-active' : '' }}">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Lịch bảo trì
                    </a>
                    <a href="{{ route('admin.lienhe.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.lienhe.*') ? 'saas-sidebar-link-active' : '' }}">
                        <div class="flex items-center gap-3">
                        ...
                        @if ($soLienHeChoXuLy > 0)
                            <span class="ml-auto saas-badge saas-badge-warning">{{ $soLienHeChoXuLy }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.thongbao.index') }}" class="saas-sidebar-link {{ request()->routeIs('admin.thongbao.*') ? 'saas-sidebar-link-active' : '' }}">
        ...
        <div class="p-4 border-t border-white/10">
            <div class="flex items-center gap-3 p-2 rounded-lg bg-white/10 border border-white/10">
                ...
                <div class="min-w-0 flex-1">
                    <div class="truncate text-xs font-semibold text-white">{{ $tenNguoiDung }}</div>
