        ...
        <nav class="flex-1 overflow-y-auto px-4 space-y-8 scrollbar-hide">
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    @endif
                    @can('cauhinh.manage')
                        <a href="{{ route('admin.quanlycauhinh') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlycauhinh') ? 'saas-sidebar-link-active' : '' }}">
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.quanlysinhvien') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlysinhvien') ? 'saas-sidebar-link-active' : '' }}">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        Sinh viên
                    </a>
                    <a href="{{ route('admin.duyetdangky') }}" class="saas-sidebar-link {{ request()->routeIs('admin.duyetdangky') ? 'saas-sidebar-link-active' : '' }}">
                        <div class="flex items-center gap-3">
                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            <span>Đăng ký</span>
                        </div>
                        @if ($soDonChoDuyet > 0)
                            <span class="ml-auto flex h-4 w-4 items-center justify-center rounded-full bg-blue-600 text-[10px] font-bold text-white">{{ $soDonChoDuyet }}</span>
                        @endif
                    </a>
                    <a href="{{ route('admin.quanlyhopdong') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlyhopdong', 'admin.hopdong.*') ? 'saas-sidebar-link-active' : '' }}">
                    ...
                    @can('kyluat.manage')
                        <a href="{{ route('admin.quanlykyluat') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlykyluat') ? 'saas-sidebar-link-active' : '' }}">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.quanlyhoadon') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlyhoadon', 'admin.hoadon.*') ? 'saas-sidebar-link-active' : '' }}">
            ...
            <div>
                ...
                <div class="space-y-1">
                    <a href="{{ route('admin.quanlybaohong') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlybaohong') ? 'saas-sidebar-link-active' : '' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.quanlylienhe') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlylienhe') ? 'saas-sidebar-link-active' : '' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.quanlythongbao') }}" class="saas-sidebar-link {{ request()->routeIs('admin.quanlythongbao') ? 'saas-sidebar-link-active' : '' }}">
        ...
        <div class="p-4 border-t border-slate-200">
            <div class="flex items-center gap-3 p-2 rounded-lg bg-slate-50 border border-slate-100">
                ...
                <div class="min-w-0 flex-1">
                    <div class="truncate text-xs font-semibold text-slate-900">{{ $tenNguoiDung }}</div>
