            ...
            <form method="POST" action="{{ route('admin.phong.luu') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <select name="toa_nha_id" class="saas-input font-bold" required>
                            ...
                            @foreach($toanhis as $toa)
                                <option value="{{ $toa->id }}">{{ $toa->ten_toa_nha }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="space-y-2">
                        <label class="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-1">Vị trí tầng</label>
                        <input name="tang" type="number" value="{{ old('tang') }}" class="saas-input font-bold" placeholder="VD: 1, 2..." required />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input name="ten_phong" value="{{ old('ten_phong') }}" class="saas-input font-bold" placeholder="VD: P.101" required />
                        <input type="hidden" name="loai_phong_id" value="{{ $loaiphongs->first()->id ?? 1 }}" />
                    </div>
                    <div class="space-y-2">
                ...
                <form method="POST" action="{{ route('admin.phong.capnhat', ['id' => $phong->id]) }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <select name="toa_nha_id" class="saas-input font-bold" required>
                                @foreach($toanhis as $toa)
                                    <option value="{{ $toa->id }}" @selected($phong->toa_nha_id == $toa->id)>{{ $toa->ten_toa_nha }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="space-y-2">
                            <label class="text-[10px] font-bold uppercase tracking-widest text-slate-400 ml-1">Vị trí tầng</label>
                            <input name="tang" type="number" value="{{ $phong->tang }}" class="saas-input font-bold" required />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input name="ten_phong" value="{{ $phong->ten_phong }}" class="saas-input font-bold" required />
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="gioi_tinh_han_che" class="saas-input font-bold" required>
                                @foreach(\App\Enums\Gender::cases() as $gender)
                                    <option value="{{ $gender->value }}" @selected($phong->gioi_tinh_han_che->value == $gender->value)>{{ $gender->label() }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="mo_ta" rows="3" class="saas-input !h-auto !py-4 resize-none font-medium">{{ $phong->mo_ta }}</textarea>
                    </div>
