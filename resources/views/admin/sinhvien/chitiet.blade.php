    ...
    <div class="space-y-8 animate-fade-in pb-20">
        ...
        >
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.quanlysinhvien') }}" class="saas-btn-secondary h-9 px-4 text-xs">
                ...
                <div class="saas-card p-8 text-center relative overflow-hidden group border-slate-200/60 shadow-sm hover:shadow-md transition-all">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-center justify-center gap-2 mt-2">
                            <span class="text-[10px] font-bold text-blue-600 uppercase tracking-widest bg-blue-50 px-3 py-1 rounded-lg border border-blue-100">{{ $sinhvien->ma_sinh_vien }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                @if($sinhvien->phong_hien_tai())
                                    ...
                                    <div class="text-[9px] font-bold text-blue-400 mt-1 uppercase tracking-widest">{{ $sinhvien->phong_hien_tai()->toanha?->ten_toa_nha }}</div>
                                @else
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="saas-card p-5 bg-slate-50/50 border-none group hover:bg-white hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-2xl font-bold text-slate-900 tabular-nums tracking-tight group-hover:text-blue-600 transition-colors">{{ $sinhvien->hopdongs->count() }}</div>
                    ...
                    <div class="saas-card p-5 bg-blue-50/20 border-none group hover:bg-white hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="text-2xl font-bold text-blue-600 tabular-nums tracking-tight">{{ $hoadons->count() }}</div>
                                        ...
                                        <tr class="hover:bg-slate-50/30 transition-all">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center gap-3 text-[10px] font-bold tabular-nums">
                                                    ...
                                                    <span class="text-blue-600">{{ $hopdong->ngay_ket_thuc->format('d/m/Y') }}</span>
                                                </div>
                                            </td>
