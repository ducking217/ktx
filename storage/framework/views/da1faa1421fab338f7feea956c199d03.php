                    ...
                    <div class="space-y-8">
                        <div class="space-y-2.5">
                            ...
                            <div class="relative group">
                                <input type="number" name="so_tang" id="so_tang" value="<?php echo e(old('so_tang', $toaNha->so_tang ?? '')); ?>" min="1" max="50" placeholder="0" class="saas-input h-12 pl-14 font-black tabular-nums transition-all group-hover:border-slate-400 focus:border-blue-500" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-2.5">
                            ...
                            <div class="relative group">
                                <input type="number" name="so_phong" id="so_phong" value="<?php echo e(old('so_phong', $toaNha->so_phong ?? '')); ?>" min="1" max="2000" placeholder="0" class="saas-input h-12 pl-14 font-black tabular-nums transition-all group-hover:border-slate-400 focus:border-blue-500" />
                                <div class="absolute inset-y-0 left-5 flex items-center text-slate-400 group-hover:text-blue-500 transition-colors">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="p-6 rounded-2xl <?php echo e(isset($toaNha) ? 'bg-slate-100 border-slate-200' : 'bg-blue-50 border-blue-100/50 shadow-blue-500/5'); ?> border shadow-sm mt-4">
                            <div class="flex gap-4">
                                <svg class="h-5 w-5 <?php echo e(isset($toaNha) ? 'text-slate-400' : 'text-blue-500'); ?> flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                <p class="text-[11px] font-bold <?php echo e(isset($toaNha) ? 'text-slate-500' : 'text-blue-700'); ?> leading-relaxed uppercase tracking-tight">
                                    <?php if(isset($toaNha)): ?>
                                        Áp dụng khi hệ thống tự tạo thêm phòng theo quy mô mới, các phòng đã tồn tại sẽ giữ nguyên.
                                    <?php else: ?>
                                        Quy tắc khởi tạo tự động: <span class="<?php echo e(isset($toaNha) ? 'text-slate-900' : 'text-blue-900'); ?>">[MãTòa][Tầng][STT]</span> (Ví dụ: A1101, B2105...).
                                    <?php endif; ?>
                                </p>
                            </div>
                        </div>
