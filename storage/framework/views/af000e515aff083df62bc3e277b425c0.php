                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-5 text-right">
                            ...
                            <span class="saas-badge <?php echo e($badgeClass); ?>">
                                <?php if($mucdoEnum === \App\Enums\DisciplineLevel::High->value): ?>
                                    <span class="mr-1.5 h-1.5 w-1.5 rounded-full bg-current animate-pulse"></span>
                                <?php endif; ?>
                                <?php echo e($item->muc_do?->label() ?? 'Bình thường'); ?>
...
<?php endif; ?>
        ...
        <?php if(method_exists($kyluat, 'links') && $kyluat->hasPages()): ?>
            <div class="mt-8">
                <?php echo e($kyluat->links()); ?>
...
<?php echo $__env->make('student.layouts.chinh', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\hethongquanlyktxv1\resources\views/student/kyluatcuaem.blade.php ENDPATH**/ ?>