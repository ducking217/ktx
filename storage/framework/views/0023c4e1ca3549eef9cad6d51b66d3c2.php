...
>
    ...
    <div
        x-show="show"
        class="linear-modal-card mb-6 overflow-hidden transform transition-all sm:mx-auto sm:w-full text-left <?php echo e($maxWidth); ?> <?php echo e($title ? 'rounded-2xl bg-ui-card ring-1 ring-ui-border shadow-xl' : ''); ?>"
        x-transition:enter="ease-out duration-300"
