...
<body class="saas-layout text-slate-900">
<?php
...
<!-- Sidebar -->
<aside class="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-slate-200 bg-slate-50/50 lg:flex backdrop-blur-xl">
    <!-- Brand Logo -->
    ...
    <nav class="flex-1 overflow-y-auto px-4 py-4 custom-scrollbar">
        ...
        <div class="space-y-1">
            <?php if(!$isAlumni): ?>
                <a href="<?php echo e(route('student.danhsachphong')); ?>" class="saas-sidebar-link <?php echo e(request()->routeIs('student.danhsachphong') ? 'saas-sidebar-link-active' : ''); ?>">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('student.hopdongcuatoi')); ?>" class="saas-sidebar-link <?php echo e(request()->routeIs('student.hopdongcuatoi') ? 'saas-sidebar-link-active' : ''); ?>">
        ...
        <div class="space-y-1">
            <a href="<?php echo e(route('student.hoadoncuaem')); ?>" class="saas-sidebar-link <?php echo e(request()->routeIs('student.hoadoncuaem', 'student.phongcuatoi.hoadon.chitiet') ? 'saas-sidebar-link-active' : ''); ?>">
        ...
        <div class="space-y-1">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('student.kyluatcuaem')); ?>" class="saas-sidebar-link <?php echo e(request()->routeIs('student.kyluatcuaem') ? 'saas-sidebar-link-active' : ''); ?>">
...
<div class="flex flex-1 flex-col lg:pl-64">
    <!-- Topbar -->
    <header class="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between border-b border-slate-200/60 bg-white/80 px-6 backdrop-blur-xl transition-all">
        <div class="flex items-center gap-4">
            <h1 class="font-display text-lg font-bold tracking-tight text-slate-900">
                ...
                <?php else: ?>
                    <?php echo $__env->yieldContent('student_page_title', 'Dashboard'); ?>
                <?php endif; ?>
            </h1>
        </div>
...
<nav class="fixed bottom-6 left-1/2 z-50 flex w-[calc(100%-3rem)] max-w-sm -translate-x-1/2 items-center justify-around rounded-2xl border border-slate-200/60 bg-white/95 p-2 shadow-xl backdrop-blur-xl lg:hidden">
    ...
    <a href="<?php echo e(route('student.hoadoncuaem')); ?>" class="flex flex-col items-center gap-1 rounded-xl p-2 transition-colors relative <?php echo e(request()->routeIs('student.hoadoncuaem') ? 'text-slate-900 bg-slate-100' : 'text-slate-500 hover:text-slate-900'); ?>">
