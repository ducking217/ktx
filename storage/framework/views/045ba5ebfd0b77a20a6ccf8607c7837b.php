                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="py-5 text-center">
                            ...
                            <span class="saas-badge <?php echo e($statusBadgeInvoice); ?>">
                                <?php echo e($statusInvoice->label()); ?>
                        ...
                        <td class="py-5 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <?php if($hoadon->trang_thai !== \App\Enums\InvoiceStatus::Paid): ?>
                                    ...
                                    ?>
                                    <form action="<?php echo e(route('admin.xacnhanthanhtoan', $hoadon->id)); ?>" method="POST" data-confirm="<?php echo e(e($confirmText)); ?>" onsubmit="return confirm(this.dataset.confirm)">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="saas-btn-primary h-9 px-3 text-xs font-semibold">
                                            <?php echo e($isRefund ? 'Xác nhận hoàn' : 'Xác nhận'); ?>
...
<?php $component->withAttributes(['id' => 'modal-xulyhoadon','title' => 'Ghi chỉ số điện nước','subtitle' => 'Nhập chỉ số điện nước định kỳ để hệ thống tự động tạo hóa đơn tháng.']); ?>
            <form method="POST" action="<?php echo e(route('admin.xulyhoadon')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                <div class="space-y-2">
