...
<body>
    ...
    <a href="<?php echo e($url); ?>" class="button">Đăng nhập ngay</a>
    
    <p>Link này sẽ hết hạn sau 72 giờ.</p>
    
    <div class="footer">
        <p>Đây là email tự động, vui lòng không phản hồi.</p>
        <p>&copy; <?php echo e(date('Y')); ?> Ban Quản lý Ký túc xá.</p>
    </div>
</body>
</html>
<?php /**PATH D:\laragon\www\hethongquanlyktxv1\resources\views/emails/student-magic-link.blade.php ENDPATH**/ ?>