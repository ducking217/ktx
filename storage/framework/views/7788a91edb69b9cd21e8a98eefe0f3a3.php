...
<?php if($toast_loai && $toast_noidung): ?>
    ...
    <div class="fixed bottom-5 right-5 z-50 animate-pop-in">
        <div id="toast-thongbao" class="linear-panel flex w-full max-w-sm items-start gap-3 p-3" role="alert" aria-live="assertive">
            <div class="inline-flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-md border <?php echo e($mau); ?>" aria-hidden="true">
                <?php if($toast_loai === 'thanhcong' || $toast_loai === 'success'): ?>
            ...
            <div class="min-w-0 flex-1">
                <div class="text-xs font-bold tracking-wide text-slate-900"><?php echo e($tieude); ?></div>
                <div class="mt-0.5 text-sm text-slate-600"><?php echo e($toast_noidung); ?></div>
            </div>
            <button type="button"
