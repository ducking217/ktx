...
<body>
    ...
    <div class="terms">
        <p>Hôm nay, ngày <?php echo e(date('d')); ?> tháng <?php echo e(date('m')); ?> năm <?php echo e(date('Y')); ?>, chúng tôi gồm:</p>
        ...
        <table class="content-table">
            ...
            <tr>
                ...
                <td>
                    Từ ngày
                    <?php if($hopdong->ngay_bat_dau): ?>
                        <?php echo e(date('d/m/Y', strtotime($hopdong->ngay_bat_dau))); ?>

                    <?php else: ?>
                        ........
                    <?php endif; ?>
                    đến hết ngày
                    <?php if($hopdong->ngay_ket_thuc): ?>
                        <?php echo e(date('d/m/Y', strtotime($hopdong->ngay_ket_thuc))); ?>
...
<?php /**PATH D:\laragon\www\hethongquanlyktxv1\resources\views/pdf/hopdong.blade.php ENDPATH**/ ?>