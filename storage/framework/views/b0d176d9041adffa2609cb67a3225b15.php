<header class="saas-header">
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="hidden md:flex relative group">
            <div class="absolute inset-y-0 left-3 flex items-center text-slate-400 group-focus-within:text-blue-500 transition-colors">
        ...
        <!-- Notifications -->
        <a href="<?php echo e(route('admin.quanlythongbao')); ?>" class="saas-btn-secondary !p-2 relative">
            ...
            <?php if(($soYeuCauTraPhongMoi ?? 0) > 0): ?>
                <span class="absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-rose-500 ring-2 ring-white"></span>
            <?php endif; ?>
        </a>

        <!-- Profile -->
        <a href="<?php echo e(route('profile.edit')); ?>" class="saas-btn-secondary gap-2.5 px-3">
...
<?php /**PATH D:\laragon\www\hethongquanlyktxv1\resources\views/admin/partials/navbar.blade.php ENDPATH**/ ?>