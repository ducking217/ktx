            ...
            <article class="saas-card p-6 flex flex-col justify-between group hover:border-slate-300 transition-all">
                <div class="mb-5">
                    ...
                    <div class="flex items-baseline gap-1 mb-1">
                        <span class="text-2xl font-bold tracking-tight tabular-nums <?php echo e($tongTienCanDong > 0 ? 'text-rose-600' : 'text-brand-emerald'); ?>"><?php echo e(number_format($tongTienCanDong)); ?></span>
                        <span class="text-xs font-bold text-slate-300">VNĐ</span>
                    </div>
                    <div class="text-[11px] font-bold uppercase tracking-widest <?php echo e($tongTienCanDong > 0 ? 'text-rose-400' : 'text-brand-emerald/70'); ?>">
                        <?php echo e($tongTienCanDong > 0 ? 'Cần thanh toán ngay' : 'Đã hoàn tất nghĩa vụ'); ?>

                    </div>
                </div>
                <a href="<?php echo e(route('student.hoadon.index')); ?>" class="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-brand-emerald hover:text-brand-emerald/80 transition-colors w-fit">
                    Chi tiết hóa đơn
            ...
            <div class="lg:col-span-8 space-y-8">
                <article class="saas-card overflow-hidden">
                    <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/30">
                        ...
                        <a href="<?php echo e(route('student.hoadon.index')); ?>" class="text-[10px] font-bold uppercase tracking-widest text-brand-emerald hover:text-brand-emerald/80">Tất cả</a>
                    </div>
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <?php $__currentLoopData = $quickActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route($action['route'], $action['params'] ?? [])); ?>" class="saas-card p-5 group flex flex-col items-center gap-3 transition-all hover:border-slate-300 text-center">
                    ...
                    <div class="divide-y divide-slate-50">
                        <?php $__empty_1 = true; $__currentLoopData = $thongbao; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('student.chitietthongbao', $item->id)); ?>" class="group block p-5 transition-colors hover:bg-slate-50/50">
                                ...
                                <h4 class="text-xs font-bold text-slate-900 leading-snug line-clamp-2 tracking-tight group-hover:text-brand-emerald transition-colors"><?php echo e($item->tieu_de); ?></h4>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="py-12 text-center">
                        ...
                        <div class="space-y-5">
                            <?php $__currentLoopData = $lienhekhancap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-col gap-1 group/line">
                                    ...
                                    <a href="tel:<?php echo e($contact['phone']); ?>" class="text-sm font-bold tabular-nums tracking-tight hover:text-brand-emerald transition-colors text-slate-300"><?php echo e($contact['phone']); ?></a>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
