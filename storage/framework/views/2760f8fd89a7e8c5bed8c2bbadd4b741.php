        ...
        <div class="p-6">
            <div class="flex items-start gap-4">
                <div class="flex-shrink-0">
                    <div class="h-10 w-10 rounded-full <?php echo e($style['bg']); ?> flex items-center justify-center">
                        <svg class="h-5 w-5 <?php echo e($style['icon']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <?php if($type === 'danger'): ?>
                ...
                <div class="flex-1">
                    <h3 class="text-base font-semibold text-ink-primary"><?php echo e($title); ?></h3>
                    <p class="mt-1 text-sm text-ink-secondary/80"><?php echo e($message); ?></p>
                </div>
            </div>
...
<?php /**PATH D:\laragon\www\hethongquanlyktxv1\resources\views/components/confirmation-modal.blade.php ENDPATH**/ ?>